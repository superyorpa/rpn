...
8 satu digit, maka hasilnya adalah 8. 654 => 0. Karena 654 tiga digit, 
maka lakukan 6 * 5 * 4 = 120. 120 tiga digit, maka lakukan 1 * 2 * 0 = 0. 0 satu digit, maka hasilnya adalah 0.
*/
...
function kaliTerusRekursif(angka) {
  ...
  */
  ...
  let hasilKali = digitTerakhir * kaliTerusRekursif(sisaDigit);
