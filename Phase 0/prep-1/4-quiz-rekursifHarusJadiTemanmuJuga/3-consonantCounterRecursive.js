...
function consonantCounterRecursive(sentences) {
  if(sentences.length === 0 || !sentences) return 0;

  let char = sentences[0].toLowerCase();
  let isTrue = (char >= 'a' && char <= 'z') && char !== 'a' && char !== 'i' && char !== 'u' && char !== 'e' && char !== 'o'; 
  
  return isTrue + consonantCounterRecursive(sentences.slice(1));
}
